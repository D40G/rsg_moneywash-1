...
Config.MoneyType = 'dirtymoney' -- type example 'dirtymoney' or 'markedbills'
Config.CutPercentage = 100 -- percentage of cash player gets when washed : example 10 = 10% / 50 = 50% / 100 = 100%  / 200 = 200% (double)
Config.MinAmount = 100 -- minimum amount of dirty money you set to wash
Config.CheckTime = 10000 -- amount of time in milliseconds needed to check your dirty money
